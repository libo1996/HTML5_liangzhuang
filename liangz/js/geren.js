...
{
alert("今日已签到，积分+20 !");
var x=document.getElementById("fen").innerHTML; 
x=parseInt(x)+20; 
document.getElementById("fen").innerHTML=x; 
}
...
function showImg(){ 
	if (document.getElementById("we").style.display=="block") 
		{ 
...
function showImg1(){ 
	if (document.getElementById("we1").style.display=="block") 
		{ 
			document.getElementById("we1").style.display="none"; 
		} else {
		 document.getElementById("we1").style.display="block";
		  } }
