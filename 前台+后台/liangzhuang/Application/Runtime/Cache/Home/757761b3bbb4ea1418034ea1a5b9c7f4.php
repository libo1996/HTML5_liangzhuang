...
<div class="content">
<!-- 列表 -->
<div class="content-text4" style="margin-left:10%">
    <?php if(is_array($hotel)): $i = 0; $__LIST__ = $hotel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="qbmstp" style="clear: left">
              <img  src="/weiju2/Public/<?php echo ($vo["thumb"]); ?>" width="100%" height="330px" />
            </div>
            <div class="qbmswz">
            <h2 style="text-align:center;font-size:20px"><?php echo ($vo["name"]); ?></h2>
            <p><font style="font-size:16px;font-weight:500">具体位置：</font><?php echo ($vo["address"]); ?></p>
            <p><font style="font-size:16px;font-weight:500">酒店简介:</font><?php echo ($vo["hotel_introduce"]); ?></p>
