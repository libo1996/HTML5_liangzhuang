				...
				<div id="mbx">
					<ul id="breadcrumb">
						<li><a href="<?php echo U('Home/index/index');?>"><span class="icon icon-home"> </span>首页</a></li>
  						...
  						<li><a href="<?php echo U('Home/zhuyi/zhuyishixiang_sq');?>"><span class="icon icon-double-angle-right"></span> 时区</a></li>
  					</ul>
				</div>
			...
			<div class="content-footer">
				...
				<div class="lanrenzhijia" id="lanrenzhijia">
					<ul>
						...
						<li class="on"><a href="<?php echo U('Home/zhuyi/zhuyishixiang_sq');?>">时区</a></li>
					...
					<div class="hover" style="top: 100px;"></div>
				</div>
				...
				<div class="content-text">
					<div id="zw">
						...
						<p id="zw">
							...
							夏令时
							<br/><br/>
							在夏季，新南威尔士、维多利亚、南澳大利亚、塔斯马尼亚和澳大利亚首都领地将时钟调快一小时，实行夏令时（DST）。夏令时从十月的第一个星期日凌晨 2:00（AEST）开始，到次年四月的第一个星期日的凌晨 3:00（澳大利亚东部夏令时）结束。
							<br/><br/>
							新南威尔士、澳大利亚首都领地、维多利亚和塔斯马尼亚从澳大利亚东部标准时间（AEST）调到澳大利亚东部夏令时（AEDT），UTC +11。南澳大利亚和新南威尔士的布罗肯山镇从澳大利亚中部标准时间（ ACST） 调到澳大利亚中部夏令时（ACDT），UTC +10½。昆士兰、北领地和西澳大利亚均不采用夏令时。
							<br/><br/>
							世界时区
							<br/><br/>
							格林威治标准时间（GMT）位于零度经度线位置，世界时区就是按这条线向东和向西进行计算。现在已广泛使用世界协调时（UTC）这一术语。国际日期变更线穿过太平洋（Pacific Ocean），使日期相差一天。如果你向东跨过日期变更线，则减去一天；如果向西，则增加一天（局部地区有所变动）。直接从洛杉矶（Los Angeles）或伦敦（London）前往澳大利亚，你将在两天后到达；返回时，你会在与出发时相同的日期到达。当然，前提是你到达后即刻离开。
							<br/><br/><br/>
						</p>
					</div>
				</div>
