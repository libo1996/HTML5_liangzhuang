    ...
    <div id="light1" class="white_content1">
		...
		<div class="content">
				...
				<div id="mbx">
					<ul id="breadcrumb">
						<li><a href="<?php echo U('Home/index/index');?>"><span class="icon icon-home"> </span>首页</a></li>
  						...
  						<li><a href="<?php echo U('Home/yaoqu/yaoqu_xiaodaliya');?>"><span class="icon icon-double-angle-right"></span>西澳大利亚州</a></li>
  					</ul>
				</div>
			...
			<div class="content-footer">
				...
				<div class="lanrenzhijia" id="lanrenzhijia">
					<ul>
						...
						<li class="on"><a href="<?php echo U('Home/yaoqu/yaoqu_xiaodaliya');?>">西澳大利亚</a></li>
			...
			<div class="content-text">
				<?php if(is_array($state)): $i = 0; $__LIST__ = array_slice($state,5,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="zw">
