...
<html>
    <head>
        ...
        <!--界面和面包屑-->
        <link rel="stylesheet" href="/weiju2/Public/home/css/xingcheng.css">
...
<!-- 列表 -->
<div class="lists">
    <?php if(is_array($strategy)): $i = 0; $__LIST__ = $strategy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list">
        <div class= "dddd1">
           <a href="<?php echo U('Home/xingcheng/xingcheng_content');?>/sid/<?php echo ($vo["sid"]); ?>"><img src="/weiju2/Public/<?php echo ($vo["pic"]); ?>"  class="list_img"></a>
        </div>
        <div class="list_content">
            <h2><?php echo ($vo["title"]); ?></h2>
            <br/>
            <p><?php echo ($vo["route"]); ?></p><br/><p><?php echo ($vo["content"]); ?></p>
        </div>
   </div><?php endforeach; endif; else: echo "" ;endif; ?>

  
</div>
                <div class="zw" style="padding-top:30px; ">
