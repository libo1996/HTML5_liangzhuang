...
<div class="clearfix"></div>					
		...
		jQuery(document).ready(function($) {
			...
			<div id="small-dialog" class="mfp-hide">
						<div class="image-top">
							<video width="420" height="500" controls>  <source src="/liangzhuang/Public/home/video/1.mp4" type="video/mp4">  <source src="movie.ogg" type="video/ogg">  <source src="movie.webm" type="video/webm">  <object data="video/0.blv" width="320" height="240">    <embed src="movie.swf" width="320" height="240">  </object> </video>
						</div>
					</div>
					<div id="small-dialog1" class="mfp-hide">
						<div class="image-top">
							<video width="420" height="500" controls>  <source src="/liangzhuang/Public/home/video/2.mp4" type="video/mp4">  <source src="movie.ogg" type="video/ogg">  <source src="movie.webm" type="video/webm">  <object data="video/2.mp4" width="320" height="240">    <embed src="movie.swf" width="320" height="240">  </object> </video>
						</div>
					</div>
