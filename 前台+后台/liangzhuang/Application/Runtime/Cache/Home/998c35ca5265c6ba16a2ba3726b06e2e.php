		...
		<div class="content">
				...
				<div id="mbx">
					<ul id="breadcrumb">
						<li><a href="<?php echo U('Home/index/index');?>"><span class="icon icon-home"> </span>首页</a></li>
  						<li><a href="<?php echo U('Home/siji/sijituijian');?>"><span class="icon icon-beaker"> </span> 四季推荐</a></li>
  						<li><a href="<?php echo U('Home/siji/sijituijian');?>"><span class="icon icon-double-angle-right"></span> 夏</a></li>
  					</ul>
				</div>
			...
			<div class="content-footer">
				...
				<div class="lanrenzhijia" id="lanrenzhijia">
					<ul>
						<li class=""><a href="<?php echo U('Home/siji/sijituijian');?>">春</a></li>
						<li class="on"><a href="<?php echo U('Home/siji/sijituijian_xia');?>">夏</a></li>
						<li class=""><a href="<?php echo U('Home/siji/sijituijian_qiu');?>">秋</a></li>
						<li class=""><a href="<?php echo U('Home/siji/sijituijian_dong');?>">冬</a></li>
					</ul>
					<div class="hover" style="top: 100px;"></div>
				</div>
			
				<div class="content-text">
					<?php if(is_array($sight)): $i = 0; $__LIST__ = $sight;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div id="zw">
						<h1><a href="<?php echo U('Home/yaoqu/content');?>"><?php echo ($vo["name"]); ?></a></h1>
