...
<link rel="stylesheet" href="/liangzhuang/Public/home/css/bootstrap.min.css" type="text/css" />
	...
	<div class="container">
	   <div class="header-bottom">
		...
		<div class="clearfix"></div>
			...
			<div class="container">
				<div class="our-work-section-head text-center" id="zc">
	     
		  <h3>种草</h3>
	</div>
	    <!-- 内容 -->
	    <div class="container">
	    	<?php if(is_array($zc)): $i = 0; $__LIST__ = $zc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="content">
			...
			<div class="row clearfix">
				<div class="col-md-4 column">
					<div class="img">
					<img src="/liangzhuang/Public/<?php echo ($vo["img1"]); ?>" width="200px"/>
					<h3>
						<?php echo ($vo["name1"]); ?>
					</h3>
				    </div>
				...
				<div class="col-md-4 column">
					<div class="img">
					<img src="/liangzhuang/Public/<?php echo ($vo["img2"]); ?>" width="200px" height="200px"/>
					<h3>
						<?php echo ($vo["name2"]); ?>
					</h3>
				    </div>
				...
				<div class="col-md-4 column">
					<div class="img">
					<img src="/liangzhuang/Public/<?php echo ($vo["img3"]); ?>" width="200px" height="200px"/>
					<h3>
						<?php echo ($vo["name1"]); ?>
					</h3>
				    </div>
				<div class="but">
				<a href="<?php echo U('Home/zc/zc_content');?>/zid/<?php echo ($vo["zid"]); ?>"><button>更多</button></a>
			    </div>
			    </div>
		    </div>
			...
			<div class="row clearfix">
				<div class="col-md-4 column">
					<div class="img">
					<img src="/liangzhuang/Public/home/images/zc6.jpg" width="200px"/>
					<h3>
						rmk2016年春季新品控油防晒粉底液
					</h3>
				    </div>
				...
				<div class="col-md-4 column">
					<div class="img">
					<img src="/liangzhuang/Public/home/images/zc7.jpg" width="200px" height="200px"/>
					<h3>
						棉花糖粉饼
					</h3>
				    </div>
				...
				<div class="col-md-4 column">
					<div class="img">
					<img src="/liangzhuang/Public/home/images/zc8.jpg" width="200px" height="200px"/>
					<h3>
						城野先生控油收缩毛孔化妆水
					</h3>
				    </div>
				<div class="but">
				<a href="<?php echo U('Home/zc/zc_content');?>"><button>更多</button></a>
			    </div>
			    </div>
		    </div>
	        </div>
			...
			<div class="row clearfix">
				<div class="col-md-4 column">
					<div class="img">
					<img src="/liangzhuang/Public/home/images/zc9.jpg" width="200px"/>
					<h3>
						SANA豆乳隔离妆前乳
					</h3>
				    </div>
				...
				<div class="col-md-4 column">
					<div class="img">
					<img src="/liangzhuang/Public/home/images/zc10.jpg" width="200px" height="200px"/>
					<h3>
						Laura Mercier 补水妆前乳
					</h3>
				    </div>
				...
				<div class="col-md-4 column">
					<div class="img">
					<img src="/liangzhuang/Public/home/images/zc11.jpg" width="200px" height="200px"/>
					<h3>
						Sofina 控油妆前乳
					</h3>
				    </div>
