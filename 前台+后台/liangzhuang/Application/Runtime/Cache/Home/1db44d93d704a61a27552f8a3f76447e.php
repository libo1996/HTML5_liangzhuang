...
<html>
	<head>
		...
		<script src="/weiju2/Public/home/js/jquery-1.10.2.min.js"></script>
        <script src="/weiju2/Public/home/js/lightbox-2.6.min.js"></script>
        <!-- 评论区 -->
        <link  rel="stylesheet" href="/weiju2/Public/home/css/main1.css" />
		<link rel="stylesheet" type="text/css" href="/weiju2/Public/home/css/sinaFaceAndEffec.css" /> 
		<script type="text/javascript" src="/weiju2/Public/home/js/main.js"></script>
	    <script type="text/javascript" src="/weiju2/Public/home/js/sinaFaceAndEffec.js"></script>
		<style type="text/css">
			#btn1 {
...
#btn1 :active {
    ...
    <div id="light1" class="white_content1">
		...
		<div class="content">
			...
			<div class="content-text">	
			    ...
			    <div class="div1" style="margin-left:20%;float:left"> 
			      <img src="/weiju2/Public/<?php echo ($guide["guide_thumb"]); ?>" height="160px" width="89%">
			      <p style="text-align:center;"><?php echo ($guide["gname"]); ?></p>
			      <p style="text-align:center;"><?php echo ($guide["school"]); ?></p>
                ...
                <div id="biaoge" class="flex-container">
			       ...
			       <table>
				    ...
				    <tr>
						...
						<td style="text-align:center;"><?php echo ($guide["introduce"]); ?></td>
					</tr>
				    <tr>
						<td style="text-align:center;">就读学校</td>
						<td style="text-align:center;"><?php echo ($guide["school"]); ?></td>
					</tr>
					
					<tr>
						<td style="text-align:center;">工作时间</td>
						<td style="text-align:center;"><?php echo ($guide["worktime"]); ?></td>
					</tr>
					<tr>
						<td style="text-align:center;">工作地点范围</td>
						<td style="text-align:center;"><?php echo ($guide["workplace"]); ?></td>
					</tr>
					<tr>
						<td style="text-align:center;">收费</td>
						<td style="text-align:center;"><?php echo ($guide["pay"]); ?></td>
					</tr>
					<tr>
						<td style="text-align:center;">游玩内容</td>
						<td style="text-align:center;"><?php echo ($guide["play"]); ?></td>
					</tr>
					<tr>
						<td style="text-align:center;">是否提供接机</td>
						<td style="text-align:center;"><?php echo ($guide["plane"]); ?></td>
					</tr>
					<tr>
						<td style="text-align:center;">联系方式</td>
						<td style="text-align:center;">电话：<?php echo ($guide["number"]); ?></td>
					</tr>
		    ...
		    <div id="jc" style="margin-left:20%;margin-top:5%">
				<a href="#"><h1>精彩瞬间</h1></a>
				<p>注：精彩瞬间是该导游带游客时拍的照片</p>
			</div>
            
            <div class="image-row1">
			<div class="image-set1" style="margin-left:20%">
				<a class="example-image-link" href="/weiju2/Public/<?php echo ($guide["pic"]); ?>" data-lightbox="example-set" ><img class="example-image1" src="/weiju2/Public/<?php echo ($guide["pic"]); ?>"  width="189" height="170"/></a>
				<a class="example-image-link" href="/weiju2/Public/home/images/u143.jpg" data-lightbox="example-set" ><img class="example-image1" src="/weiju2/Public/home/images/u143.jpg"  width="189" height="170"/></a>
				<a class="example-image-link" href="/weiju2/Public/home/images/u145.jpg" data-lightbox="example-set" ><img class="example-image1" src="/weiju2/Public/home/images/u145.jpg" width="189" height="170"/></a>
				<a class="example-image-link" href="/weiju2/Public/home/images/u149.jpg" data-lightbox="example-set" ><img class="example-image1" src="/weiju2/Public/home/images/u149.jpg" width="189" height="170"/></a>
        ...
        <div id="content" style="width: 50%; height: auto;margin-left:20%;margin-top:5%">
			<div class="wrap">
				<div class="comment">
					<div class="head-face">
						<img src="/weiju2/Public/home/images/u32.png"  / >
						<p>asdf</p>
					</div>
					<div class="content	">
						<div class="cont-box">
						...
						<div class="tools-box">	
							...
							<span class="face-icon" >☺</span><span class="img-icon">▧</span></div>
    ...
    function senddata(){
    var yyy = document.getElementById("xx1").value;
	var obj;
	...
	obj.innerHTML=yyy;
		...
		function reply(content){
			...
			html += '<img src="/weiju2/Public/home/images/u32.png" / >';
			html += '</div>';
			html += '<div class="reply-cont">';
			html += '<p>zzz</p>';
			html += '<p class="comment-body">'+content+'</p>';
			html += '<p class="comment-footer">2016年10月5日　<input type = "button" id="btn1" value="回复">　点赞54　转发12</p>';
			html += '<div>';
			html += '<div style="float:left">';
			html += '<input type="tet" name="huifu" id="xx1" style="display:none">';
			html += '</div>';
			html += '<div style="float:left">';
			html += '<input type="button" name="huifu" id="btn3" value="回复" style="display:none" onclick="senddata()">';
			html += '</div>';
			html += '<div style="float:left">';
			html += '<input type="button" name="quxiao" id="btn2" value="取消" style="display:none">';
			html += '</div>';	
			html += '</div>';
			html += '</div>';
			html += '</li>';
	...
	obj.innerHTML=yyy;
		...
		<div id="content" style="width: 50%; height: auto;margin-left:20%;margin-top:5%">
			<div class="wrap">
				<div class="comment">
					<div class="head-face">
						<div><img src="/weiju2/Public/home/images/u32.png" / ></div>
		...
		<div id="content" style="width: 50%;margin-left:20%;margin-top:100px">
			<div class="wrap">
				<div class="comment">
					<div class="head-face">
						<img src="/weiju2/Public/home/images/u35.png" / >
						<p>好好</p>
					</div>
					<div class="content	">
							<p>哇，看起来很不错的样子，正有去澳大利亚玩的打算，很期待这次旅行</p></br>
                ...
                <div id="zw" style="clear:left;margin-top:3%">
