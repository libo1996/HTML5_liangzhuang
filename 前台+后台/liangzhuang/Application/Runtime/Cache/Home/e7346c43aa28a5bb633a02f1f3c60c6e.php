				...
				<div id="mbx">
					<ul id="breadcrumb">
						<li><a href="<?php echo U('Home/index/index');?>"><span class="icon icon-home"> </span>首页</a></li>
  						...
  						<li><a href="<?php echo U('Home/siji/sijituijian');?>"><span class="icon icon-double-angle-right"></span> 冬</a></li>
  					</ul>
				</div>
			...
			<div class="content-footer">
				...
				<div class="lanrenzhijia" id="lanrenzhijia">
					<ul>
						...
						<li class="on"><a href="<?php echo U('Home/siji/sijituijian_dong');?>">冬</a></li>
					</ul>
