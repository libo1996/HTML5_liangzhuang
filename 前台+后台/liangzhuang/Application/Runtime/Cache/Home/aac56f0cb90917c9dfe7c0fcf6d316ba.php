		 ...
		 <ul id="filters" class="clearfix">
					...
					<div class="portfolio card mix_all  wow bounceIn" data-wow-delay="0.4s" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
						     ...
						     <img src="/liangzhuang/Public/home/images/sc1.jpg" alt="" /><div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 "><img src="images/2.png" alt=""/></h2>
							</div></a>
							<h3>桃花妆</h3>
							<input type="button" class="vv" id="jfdh" value="150积分兑换" >
		                </div>
					...
					<div class="portfolio app mix_all  wow bounceIn" data-wow-delay="0.4s" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
						     ...
						     <img src="/liangzhuang/Public/home/images/st11.jpg" alt="" /><div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 "><img src="images/2.png" alt=""/></h2>
						  	</div></a>
                            <h3>儿童妆</h3>
					...
					<div class="portfolio icon mix_all  wow bounceIn" data-wow-delay="0.4s" data-cat="icon" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
						     ...
						     <img src="/liangzhuang/Public/home/images/sc2.jpg" alt="" /><div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 "><img src="images/2.png" alt=""/></h2>
						  	</div></a>
                            <h3>舞台妆</h3>
                            <input type="button" class="vv" id="vip" value="VIP专享" >
		                </div>
					...
					<div class="portfolio app mix_all  wow bounceIn" data-wow-delay="0.4s" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
						     ...
						     <img src="/liangzhuang/Public/home/images/sc3.jpg" alt="" /><div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 "><img src="images/2.png" alt=""/></h2>
						  	</div></a>
                            <h3>戏剧妆</h3>
                            <input type="button" class="vv" id="mf" value="免费" >
		                </div>
					...
					<div class="portfolio card mix_all  wow bounceIn" data-wow-delay="0.4s" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
						     ...
						     <img src="/liangzhuang/Public/home/images/sc4.jpg" alt="" /><div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 "><img src="images/2.png" alt=""/></h2>
						  	</div></a>
                            <h3>宴会妆</h3>
                            <input type="button" class="vv" id="jfdh" value="150积分兑换" >
		                </div>
					...
					<div class="portfolio card mix_all  wow bounceIn" data-wow-delay="0.4s" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
						     ...
						     <img src="/liangzhuang/Public/home/images/sc5.jpg" alt="" /><div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 "><img src="images/2.png" alt=""/></h2>
						  	</div></a>
                            <h3>新娘妆</h3>
                            <input type="button" class="vv" id="jfdh" value="150积分兑换" >
		                </div>
		...
		jQuery(document).ready(function($) {
		  ...
		  <!-- Script for gallery Here -->
			...
			<div id="small-dialog" class="mfp-hide">
						<div class="image-top">
							<video width="420" height="500" controls>  <source src="video/1.mp4" type="video/mp4">  <source src="movie.ogg" type="video/ogg">  <source src="movie.webm" type="video/webm">  <object data="video/0.blv" width="320" height="240">    <embed src="movie.swf" width="320" height="240">  </object> </video>
						</div>
					</div>
					<div id="small-dialog1" class="mfp-hide">
						<div class="image-top">
							<video width="420" height="500" controls>  <source src="video/2.mp4" type="video/mp4">  <source src="movie.ogg" type="video/ogg">  <source src="movie.webm" type="video/webm">  <object data="video/2.mp4" width="320" height="240">    <embed src="movie.swf" width="320" height="240">  </object> </video>
						</div>
					</div>
