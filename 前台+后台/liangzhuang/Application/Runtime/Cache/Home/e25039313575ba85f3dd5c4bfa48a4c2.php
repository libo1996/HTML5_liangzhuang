    ...
    <div id="light1" class="white_content1">
		...
		<div class="content">
			...
			<div class="content-footer">
				...
				<div class="lanrenzhijia" id="lanrenzhijia">
					<ul>
						<?php if(is_array($state)): $i = 0; $__LIST__ = $state;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class=""><a href="<?php echo U('Home/liuxue/student');?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
					<div class="hover" style="top: 40px;"></div>
				</div>
			<?php if(is_array($guide)): $i = 0; $__LIST__ = $guide;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="flex-container" style="margin-left:22%">


					<div class="divv1" style="float:left; text-align: center;">
					   <a href="<?php echo U('Home/liuxue/student1');?>/gid/<?php echo ($vo["gid"]); ?>"><img src="/weiju2/Public/<?php echo ($vo["guide_thumb"]); ?>" height="160px" width="60%" ></a>
                       <a href="<?php echo U('Home/liuxue/student1');?>"><p><?php echo ($vo["gname"]); ?></p></a>
			      	<p><?php echo ($vo["school"]); ?></p>
			      	<p>☆☆☆☆☆</p>
					</div>

					<div class="divv2" style="float:left;margin-left:4%;line-height: 28px;"> <p style="font-size:1.2rem"><?php echo ($vo["country"]); ?></br>工作时间（每日更新）：<?php echo ($vo["worktime"]); ?></br>工作地点范围：<?php echo ($vo["workplace"]); ?></br>收费：<?php echo ($vo["pay"]); ?></br>是否提供接机：<?php echo ($vo["plane"]); ?></br>联系方式：      微信    <?php echo ($vo["number"]); ?></p></div>
		...
		<div class="footer">
			...
			<div class="footerliebiao">
				...
				<div class="footerliebiao1">
					<div>
						<a href="<?php echo U('Home/xingcheng/xingcheng_hb');?>">行程推荐</a>
					</div>
					<hr color="#E4E4E4" size=1 align=center noshade class="hr3">
					<div>
						<ul>
