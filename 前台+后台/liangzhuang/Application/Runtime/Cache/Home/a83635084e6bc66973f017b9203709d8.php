		...
		<div class="content">
			<div class="content-header">
				<div id="mbx">
					<ul id="breadcrumb">
						<li>
						<a href="<?php echo U('Home/index/index');?>"><span class="icon icon-home"> </span>首页</a></li>
	  					<li><a href="<?php echo U('Home/yaoqu/yaoqudedifang');?>"><span class="icon icon-beaker"> </span> 要去的地方</a></li>
	  					<li><a href="<?php echo U('Home/yaoqu/yaoqudedifang');?>"><span class="icon icon-beaker"> </span> <?php echo ($sight["state"]); ?></a></li>
	  					<li><a href="<?php echo U('Home/yaoqu/content');?>/sigid/<?php echo ($vo["sigid"]); ?>"><span class="icon icon-double-angle-right"></span> <?php echo ($sight["name"]); ?></a></li>
	  				</ul>
				</div>
            ...
            <div class="content-footer1">
            	<div class="content-text1">
            		<div class="zwz">
            			...
            			<div class="zwnr1">
            				<img src="/weiju2/Public/<?php echo ($sight["sight_pic"]); ?>" width="570px" height="380px" >
            			</div>
	            	</div>
	            	<div class="zwy">
	            		<div class="zwbt">
	            		...
	            		<div class="zwnr2" style="margin-top: 0px;">
	            			<p><?php echo ($sight["sight_introduce"]); ?></p>
	            		</div>
	            	</div>
            	</div>
            	<div class="content-text2">
            		<div class="image-set">
						<a class="example-image-link" href="/weiju2/Public/home/images/demopage/image-3.jpg" data-lightbox="example-set" ><img class="example-image" src="/weiju2/Public/home/images/demopage/thumb-3.jpg"  width="200" height="170"/></a>
						<a class="example-image-link" href="/weiju2/Public/home/images/demopage/image-4.jpg" data-lightbox="example-set" ><img class="example-image" src="/weiju2/Public/home/images/demopage/thumb-4.jpg"  width="200" height="170"/></a>
						<a class="example-image-link" href="/weiju2/Public/home/images/demopage/image-5.jpg" data-lightbox="example-set" ><img class="example-image" src="/weiju2/Public/home/images/demopage/thumb-5.jpg" width="200" height="170"/></a>
					</div>
					<div class="txwz">	
						<h2>特别提醒</h2>
						<p><?php echo ($sight["sight_tip"]); ?></p>
					</div>
            	</div>
            	<div class="content-text3">
            		<div class="qbwz">
            			<div class="zz">
	            			<h1>这样到这里：）</h1>
	            			<p><?php echo ($sight["traffic"]); ?></p>
            			</div>
            			<div class="ybtp">
	            			<img src="/weiju2/Public/home/images/3.jpg" width="120%" height="220px">
	            		</div>
            		</div>
            		<div class="qbwz">
            			<div class="zbwz" >
	            			<h1>游泳与水上运动</h1>
	            			<p>邦迪在澳洲土著语里意为“碎石浪”，非常恰当地描述了这个海滩的情致。每逢阳光明媚的日子，悉尼人就会聚集在邦迪海滩上享受阳光的沐浴。邦迪海滩与悉尼的其他海滩一样，海浪很大，不太适合游泳。 多数的游人或趴在海滩上晒太阳或冲浪。不过如果想要与大自然来个亲密接触，也不用太过紧张，这里有救护员365天巡逻，只要在红色和黄色的旗帜标识的范围内游泳，就基本能保证安全。 当然，除了游泳，还有许多水上运动可以开展，比如冲浪，而这里被称为“冲浪者的天堂”，澳洲人对水上运动的热爱可见一斑。如果对冲浪运动很感兴趣，可以选择在这里报读一个初学者冲浪课程，享受午后美好的阳光，感受这个“热情的海滩”的魅力。寻求宁静，不喜折腾的话，也可以带一本好书，一把遮阳伞，听着音乐，吹着海风，感受南半球的休闲与惬意。</p>
            		    </div>
	            		<div class="ybtp">
	            			<img src="/weiju2/Public/home/images/5.jpg" width="120%" height="220px">
	            		</div>
	            	</div>
	            	...
	            	<div class="qbwz">	
	            		<div class="zbwz" >
		            		<h1 >休闲娱乐</h1>
		            		<p>这里有着壮美的海岸线，沿着邦迪到库吉的悬崖观景路而行，一路上可以慢慢闲逛，在精致优雅的邦迪凉亭里品尝一客鲜奶冰淇淋；可以观看邦迪海滩救生员开展救生演示活动，甚至还可以亲身参与；也可以在悉尼的标志性场所之一邦迪冰山游泳池戏水，更可以在日落时一边领略壮观的大海美景，一边享受邦迪海滩上众多餐馆的诱人美食。 如果不巧遇到下雨天，也不用太过失望，雨天的邦迪海滩也别有一番风情，你还是可以在此地放松身心，感受大自然的神奇造化，也可以去附近的娱乐设施消磨时光。在Hall Street有许多咖啡馆，提供Wi-Fi，这条街上还有一些书店和报刊亭，都能满足你的需求。实在无聊，也可以去Westfield看一场电影。</p>
	            		</div>
	            		<div class="ybtp">
	            			<img src="/weiju2/Public/home/images/7.jpg" width="120%" height="220px">
	            		</div>
            		</div>

            		<div class="qbwzts" id="hi" >
            			<h1>邦迪集市</h1>
            			<p>  周日这里会举行热闹的邦迪集市，如果碰巧遇上，千万不要错过。邦迪集市始于1993年，每周日10:00-16:00在Bondi Beach Public School靠近海滩的广场上举行。 来这里逛一逛，你会看到琳琅满目的摆设，独立设计师的服饰、手工珠宝饰品、艺术绘画、手工艺制品、古着等。当然，如果有其他重要活动，比如马拉松，周日集市会暂停，不过一般情况下都会如期举行。</p>
				...
				<div class="content-text4">
					...
					<div class="qbms">
						<?php if(is_array($food)): $i = 0; $__LIST__ = $food;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="qbmstp" style="clear: left;">
							<img  src="/weiju2/Public/<?php echo ($vo["food_pic"]); ?>" width="450px" height="280px" />
						</div>
						<div class="qbmswz" style="margin-top: 0px">
							<p><?php echo ($vo["food_introduce"]); ?></p>
				...
				<div class="content-text5">
					...
					<?php if(is_array($hotel)): $i = 0; $__LIST__ = $hotel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="qbfjjd" style="padding-bottom:30px;">
						<a href="#"><img src="/weiju2/Public/<?php echo ($vo["thumb"]); ?>" width="360px" height="250px"></a>
						<a href="#"><h2><?php echo ($vo["name"]); ?></h2></a>
						<p><?php echo ($vo["hotel_introduce"]); ?></p>
					</div><?php endforeach; endif; else: echo "" ;endif; ?>
