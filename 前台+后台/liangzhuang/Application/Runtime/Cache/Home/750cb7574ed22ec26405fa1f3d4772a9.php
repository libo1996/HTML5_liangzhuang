...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/weiju2/Public/home/css/vendors.min.css" type="text/css">
        <link rel="stylesheet" href="/weiju2/Public/home/css/css-zh.min.css" type="text/css">
        ...
        <link href="/weiju2/Public/home/css/index.css" rel="stylesheet" type="text/css">
        <link href="/weiju2/Public/home/css/footer.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/weiju2/Public/home/js/modernizr.min.js"></script>
        <script type="text/javascript" src="/weiju2/Public/home/js/jquery.min.js"></script>
        <script type="text/javascript" src="/weiju2/Public/home/js/alljs.min(1).js"></script>
        ...
        <script type="text/javascript" src="/weiju2/Public/home/js/common.js"></script>
...
<!--content-->
    ...
    <div id="parallax_elementID_6" style="transform: translate3d(0px, 0px, 0px); top: 0px; left: 0px; x: 0px; y: 0px; position: fixed; overflow: hidden; height: 700px; width: 1349px; visibility: hidden;">
      <img src="/weiju2/Public/home/images/heroImage.adapt.1920.medium(1).jpg" style="position: absolute; max-width: none; height: 759px; width: 1349px; visibility: hidden;">
    </div>
    <div id="parallax_elementID_5" style="transform: translate3d(0px, 0px, 0px); top: 0px; left: 0px; x: 0px; y: 0px; position: fixed; overflow: hidden; height: 700px; width: 1349px; visibility: hidden;">
      <img src="/weiju2/Public/home/images/heroImage.adapt.1920.medium(2).jpg" style="position: absolute; max-width: none; height: 759px; width: 1349px; visibility: hidden;">
    </div>
    <div id="parallax_elementID_4" style="transform: translate3d(0px, 0px, 0px); top: 0px; left: 0px; x: 0px; y: 0px; position: fixed; overflow: hidden; height: 700px; width: 1349px; visibility: hidden;">
      <img src="/weiju2/Public/home/images/heroImage.adapt.1920.medium(3).jpg" style="position: absolute; max-width: none; height: 759px; width: 1349px; visibility: hidden;">
    </div>
    <div id="parallax_elementID_3" style="transform: translate3d(0px, 0px, 0px); top: 0px; left: 0px; x: 0px; y: 0px; position: fixed; overflow: hidden; height: 700px; width: 1349px; visibility: hidden;">
      <img src="/weiju2/Public/home/images/heroImage.adapt.1920.medium(4).jpg" style="position: absolute; max-width: none; height: 759px; width: 1349px; visibility: hidden;">
    </div>
    <div id="parallax_elementID_2" style="transform: translate3d(0px, 0px, 0px); top: 0px; left: 0px; x: 0px; y: 0px; position: fixed; overflow: hidden; height: 700px; width: 1349px; visibility: hidden;">
      <img src="/weiju2/Public/home/images/heroImage.adapt.1920.medium(5).jpg" style="position: absolute; max-width: none; height: 759px; width: 1349px; visibility: hidden;">
    </div>
    <div id="parallax_elementID_1" style="transform: translate3d(0px, 0px, 0px); top: 0px; left: 0px; x: 0px; y: 0px; position: fixed; overflow: hidden; height: 700px; width: 1349px; visibility: hidden;">
      <img src="/weiju2/Public/home/images/heroImage.adapt.1920.medium(6).jpg" style="position: absolute; max-width: none; height: 759px; width: 1349px; visibility: hidden;">
    </div>
    ...
    <div class="content-header">
                <div id="mbx">
                    <ul id="breadcrumb">
                        ...
                        <li><a href="<?php echo U('Home/xingcheng/xingcheng_content');?>"><span class="icon icon-double-angle-right"></span> <?php echo ($strategy["title"]); ?></a></li>
                    </ul>
                </div>
      ...
      <div class="type-summary">
          <p><?php echo ($strategy["route"]); ?></p>
      </div>
      
      <div class="type-body">
                <h1>旅程概况</h1>
                <p><?php echo ($strategy["content"]); ?></p>
            </div>
            <?php if(is_array($stra)): $i = 0; $__LIST__ = array_slice($stra,0,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="largeparallax l-padding-b">   
                  <div class="img-holder" data-parallax-height="700" style="visibility: hidden; height: 700px;"></div>
                  <div class="img-src" data-picture="">
                    <div data-media="(min-width: 1px)" data-height="290"></div>
                    <div data-media="(min-width: 481px)" data-height="500"></div>
                    <div data-media="(min-width: 769px)" data-height="700"></div>
                    <div data-media="(min-width: 993px)" data-height="700"></div>
                    <div data-media="(min-width: 1366px)" data-height="700"></div>
            </div>
              <div class="largeparallax-text">
                  <div class="largeparallax-text-container">
                      <div class="inside">
                          <h2 class=""><?php echo ($vo["day"]); ?></h2>
                      </div>
                  </div>
              </div>
        </div>
    <div class="itinerary-day-content">
        <div class="row l-center-1200">
            <div class="col-xs-6 col-sm-push-3 itinerary-day-textarea">
                <h3 class="type-h4 " style="text-align:center;font-size:20px"><?php echo ($vo["route"]); ?></h3>
                <br/>
