    ...
    <div id="light1" class="white_content1">
		...
		<div class="content">
			...
			<div class="content-footer">
				...
				<div class="lanrenzhijia" id="lanrenzhijia">
					<ul>
						...
						<li class=""><a href="<?php echo U('Home/yaoqu/yaoqu_weiduoliya');?>">维多利亚州</a></li>
			...
			<div class="content-text">
				<?php if(is_array($state)): $i = 0; $__LIST__ = array_slice($state,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="zw">
				...
				<div class="lsyg">
					<h1>风景名胜</h1>
					<?php if(is_array($sight)): $i = 0; $__LIST__ = array_slice($sight,0,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hh2">
					...
					<div style="float: right;">
						<a href="<?php echo U('Home/yaoqu/sight');?>/state_id/<?php echo ($state["state_id"]); ?>"><p>查看更多</p></a>
					</div>
				</div>
