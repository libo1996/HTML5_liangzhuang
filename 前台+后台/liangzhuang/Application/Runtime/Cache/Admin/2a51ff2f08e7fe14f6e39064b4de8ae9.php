...
text-overflow:ellipsis;/* 当对象内文本溢出时显示省略标记(...) ；需与overflow:hidden;一 起使用。*/
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">种草管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/zc/create');?>"><i class="icon-font"></i>新增种草</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($zc)): $i = 0; $__LIST__ = $zc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="<?php echo ($vo["zid"]); ?>" type="checkbox"></td>
                            <td><?php echo ($vo["zid"]); ?></td>
                            ...
                            <td><?php echo ($vo["name3"]); ?></td>
                            <td><?php echo ($vo["introduce1"]); ?></td>
                            <td><?php echo ($vo["introduce2"]); ?></td>
                            <td><?php echo ($vo["introduce3"]); ?></td>
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/zc/edit');?>/zid/<?php echo ($vo["zid"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/zc/destroy');?>/zid/<?php echo ($vo["zid"]); ?>">删除</a>
                            </td>
