...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/sight/index');?>">景点管理</a><span class="crumb-step">&gt;</span><span>新增景点</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/sight/store');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>所属城市：</th>
                                <td>
                                    <input class="common-text required" id="title" name="city" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>所属州</th>
                                <td><input class="common-text required" id="title" name="state" size="50" value="" type="text"></td>
                            </tr>
                            <tr>
                                <th>适合季节</th>
                                <td><input class="common-text required" id="title" name="season" size="50" value="" type="text"></td>
                            </tr>

                            <tr>
                                <th>景点简介：</th>
                                <td><textarea name="sight_introduce" rows="8" cols="60"></textarea></td>
                            </tr>
                             <tr>
                                <th>景点注意：</th>
                                <td><textarea name="sight_tip" rows="8" cols="60"></textarea></td>
                            </tr>
                            <tr>
                                <th>交通方式：</th>
                                <td><textarea name="traffic" rows="8" cols="60"></textarea></td>
                            </tr>
                            <tr>
                                <th>景点图片</th>
                                <td><input type="file" name="sight_pic"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
