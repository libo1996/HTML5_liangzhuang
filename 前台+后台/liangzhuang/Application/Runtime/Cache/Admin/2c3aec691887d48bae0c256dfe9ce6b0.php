...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/video/index');?>">视频管理</a><span class="crumb-step">&gt;</span><span>新增视频</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/video/store');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                         <tbody>
                            <tr>
                                <th><i class="require-red">*</i>视频分类：</th>
                                <td>
                                    <input class="common-text required" id="name" name="kind" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>视频介绍</th>
                                <td>
                                    <input class="common-text required" id="name" name="introduce" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>上传视频：</th>
