...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/stra/index');?>">子攻略管理</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/stra/edit');?>">编辑子攻略</a></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/stra/update');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red"></i>子攻略ID</th>
                                <td>
                                    <input class="common-text required"  name="id" size="50" value="<?php echo ($stra["id"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>子攻略时间</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="day" size="50" value="<?php echo ($stra["day"]); ?>" type="text">
                                </td>
                            </tr>
                            
                            <tr>
                                <th><i class="require-red"></i>子攻略内容</th>
                                <td><textarea  name="content"rows="8" cols="60"><?php echo ($stra["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th>攻略</th>
                                <td><input type="text" name="strategy" value="<?php echo ($stra["strategy"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>路线</th>
                                <td><input type="text" name="route" value="<?php echo ($stra["route"]); ?>"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
