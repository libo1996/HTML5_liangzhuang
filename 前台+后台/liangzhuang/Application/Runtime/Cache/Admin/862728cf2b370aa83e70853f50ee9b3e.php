...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/zc/index');?>">种草管理</a><span class="crumb-step">&gt;</span><span>新增种草</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/zc/store');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                           ...
                           <tr>
                                <th>介绍1</th>
                                <td><input type="text" name="introduce1"></td>
                            </tr>
                            <tr>
                                <th>介绍2</th>
                                <td><input type="text" name="introduce2" width="200px"></td>
                            </tr><tr>
                                <th>介绍3</th>
                                <td><input type="text" name="introduce3"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
