...
text-overflow:ellipsis;/* 当对象内文本溢出时显示省略标记(...) ；需与overflow:hidden;一 起使用。*/
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            </i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">所有导游</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/guide/create');?>"><i class="icon-font"></i>新增导游</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($guide)): $i = 0; $__LIST__ = $guide;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="<?php echo ($vo["gid"]); ?>" type="checkbox"></td>
                            <td>
                                <input name="ids[]" value="<?php echo ($vo["gid"]); ?>" type="hidden">
                                <input class="common-input sort-input" name="ord[]" value="<?php echo ($vo["gid"]); ?>" type="text">
                            </td>
                            ...
                            <td><?php echo ($vo["schoolpic"]); ?></td>
                            <td><?php echo ($vo["worktime"]); ?></td>
                            <td><?php echo ($vo["workplace"]); ?></td>
                            <td><?php echo ($vo["pay"]); ?></td>
                            <td><?php echo ($vo["play"]); ?></td>
                            <td><?php echo ($vo["plane"]); ?></td>
                            <td><?php echo ($vo["number"]); ?></td>
                            <td><?php echo ($vo["pic"]); ?></td>
                            <td><?php echo ($vo["introduce"]); ?></td>
                            <td><?php echo ($vo["guide_thumb"]); ?></td>
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/guide/edit');?>/gid/<?php echo ($vo["gid"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/guide/destroy');?>/gid/<?php echo ($vo["gid"]); ?>">删除</a>
                            </td>
