...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/strategy/index');?>">攻略管理</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/strategy/edit');?>">编辑攻略</a></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/strategy/update');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red"></i>攻略ID</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="sid" size="50" value="<?php echo ($strategy["sid"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>攻略标题</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="title" size="50" value="<?php echo ($strategy["title"]); ?>" type="text">
                                </td>
                            </tr>
                            
                            <tr>
                                <th><i class="require-red"></i>攻略内容</th>
                                <td><textarea  name="content"rows="8" cols="60"><?php echo ($strategy["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th>州</th>
                                <td><input type="text" name="state
                                    " value="<?php echo ($strategy["state"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>路线</th>
                                <td><input type="text" name="route" value="<?php echo ($strategy["route"]); ?>"></td>
                            </tr>
                            ...
                            <tr>
                                <th>图片：</th>
                                <td>
                                    <img src="/weiju1/Public/<?php echo ($strategy["pic"]); ?>" width="300px" height="50px"/>
