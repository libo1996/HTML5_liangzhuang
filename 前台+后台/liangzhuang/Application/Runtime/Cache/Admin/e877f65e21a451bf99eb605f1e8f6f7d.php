...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/food/index');?>">美食管理</a><span class="crumb-step">&gt;</span><span>编辑美食</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                 <form action="<?php echo U('Admin/food/update');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">                      
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th>美食ID：</th>
                                <td>
                                    <input class="common-text required" id="name" name="foodid" size="50" value="<?php echo ($food["foodid"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>美食名称：</th>
                            ...
                            <tr>
                                <th>美食图片：</th>
                                <td>
                                     <img src="/weiju2/Public/<?php echo ($food["food_pic"]); ?>" width="300px" height="50px"/>
                                    <input name="food_pic" id="" type="file">
                                </td>
                            </tr>
                            <tr>
                                <th>美食介绍</th>
                                <td><textarea  name="food_introduce"rows="8" cols="60"><?php echo ($food["food_introduce"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
