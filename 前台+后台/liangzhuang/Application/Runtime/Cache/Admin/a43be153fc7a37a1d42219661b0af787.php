...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/guide/index');?>">导游管理</a><span class="crumb-step">&gt;</span><span>新增导游</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/guide/store');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="name" name="password" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>就读学校</th>
                                <td>
                                    <input class="common-text required" id="name" name="school" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>性别</th>
                                <td>
                                    <input class="common-text required" id="name" name="sex" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>国籍</th>
                                <td>
                                    <input class="common-text required" id="name" name="country" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="name" name="worktime" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>工作地点</th>
                                <td>
                                    <input class="common-text required" id="name" name="workplace" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>收费/小时</th>
                                <td>
                                    <input class="common-text required" id="name" name="pay" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>游玩内容</th>
                                <td>
                                    <textarea  name="play"rows="8" cols="60"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>是否接机</th>
                                <td>
                                    <input class="common-text required" id="name" name="plane" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>QQ/WeChat</th>
                                <td>
                                    <input class="common-text required" id="name" name="number" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea  name="introduce"rows="8" cols="60"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th>上传头像：</th>
                                <td><input type="file" name="guide_thumb"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
