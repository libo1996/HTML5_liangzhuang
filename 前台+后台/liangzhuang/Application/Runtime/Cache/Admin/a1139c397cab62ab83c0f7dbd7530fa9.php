...
text-overflow:ellipsis;/* 当对象内文本溢出时显示省略标记(...) ；需与overflow:hidden;一 起使用。*/
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            </i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">所有视频</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/video/create');?>"><i class="icon-font"></i>新增视频</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($video)): $i = 0; $__LIST__ = $video;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="<?php echo ($vo["vid"]); ?>" type="checkbox"></td>
                            ...
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/video/edit');?>/vid/<?php echo ($vo["vid"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/video/destroy');?>/vid/<?php echo ($vo["vid"]); ?>">删除</a>
                            </td>
