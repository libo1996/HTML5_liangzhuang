...
text-overflow:ellipsis;/* 当对象内文本溢出时显示省略标记(...) ；需与overflow:hidden;一 起使用。*/
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">酒店管理</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/hotel/create');?>"><i class="icon-font"></i>新增酒店</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                         ...
                         <?php if(is_array($hotel)): $i = 0; $__LIST__ = $hotel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="<?php echo ($vo["hotel_id"]); ?>" type="checkbox"></td>
                            <td>
                                <input name="ids[]" value="<?php echo ($vo["hotel_id"]); ?>" type="hidden">
                                <input class="common-input sort-input" name="ord[]" value="<?php echo ($vo["hotel_id"]); ?>" type="text">
                            </td>
                            <td><?php echo ($vo["hotel_id"]); ?></td>
                            <td><?php echo ($vo["name"]); ?></td>
                            <td><?php echo ($vo["address"]); ?></td>
                            <td><?php echo ($vo["hotel_introduce"]); ?></td>
                            <td><?php echo ($vo["thumb"]); ?></td>
                            

                            <td>
                                <a class="link-update" href="<?php echo U('Admin/hotel/edit');?>/hotel_id/<?php echo ($vo["hotel_id"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/hotel/destroy');?>/hotel_id/<?php echo ($vo["hotel_id"]); ?>">删除</a>
                            </td>
