...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/user/index');?>">用户管理</a><span class="crumb-step">&gt;</span><span>新增用户</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="thumb" name="integral" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>密码</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="pw" size="50" value="" type="text">
                                </td>
                            </tr>
                           <tr>
                                <th><i class="require-red"></i>心愿</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="xy-id" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>收藏</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="sc-id" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>手机</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="phone" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>VIP</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="vip" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>邮箱</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="email" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>性别</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="sex" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>生日</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="birthday" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
