...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/hotel/index');?>">酒店管理</a><span class="crumb-step">&gt;</span><span>编辑酒店</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                 <form action="<?php echo U('Admin/hotel/update');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">                      <table class="insert-tab" width="100%">
                       <tbody>
                         <tr>
                                <th>酒店ID：</th>
                                <td>
                                    <input class="common-text required" id="title" name="hotel_id" size="50" value="<?php echo ($hotel["hotel_id"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>酒店名称：</th>
                                <td>
                                    <input class="common-text required" id="title" name="name" size="50" value="<?php echo ($hotel["name"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>具体位置</th>
                                <td> 
                                <input type="text"  size="50" value="<?php echo ($hotel["address"]); ?>" name="address">
                                </td>
                            </tr>
                            <tr>
                                <th>酒店简介</th>
                                <td> 
                                <textarea name="hotel_introduce" rows="8" cols="60"><?php echo ($hotel["hotel_introduce"]); ?></textarea>
                                </td>
                            </tr>
                             <tr>
                                <th>酒店图片</th>
                                <td> 
                                    <img src="/weiju1/Public/<?php echo ($hotel["thumb"]); ?>" width="300px" height="50px"/>
