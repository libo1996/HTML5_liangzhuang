...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/guide/index');?>">导游管理</a><span class="crumb-step">&gt;</span><span>编辑导游</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/guide/update');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                         <tbody>
                            <tr>
                                <th><i class="require-red">*</i>导游ID：</th>
                                <td>
                                    <input class="common-text required" id="gname" name="gid" size="50" value="<?php echo ($guide["gid"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>导游昵称：</th>
                                <td>
                                    <input class="common-text required" id="gname" name="gname" size="50" value="<?php echo ($guide["gname"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>密码：</th>
                                <td>
                                    <input class="common-text required" id="name" name="password" size="50" value="<?php echo ($guide["password"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>就读学校</th>
                                <td>
                                    <input class="common-text required" id="name" name="school" size="50" value="<?php echo ($guide["school"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>性别</th>
                                <td>
                                    <input class="common-text required" id="name" name="sex" size="50" value="<?php echo ($guide["sex"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>国籍</th>
                                <td>
                                    <input class="common-text required" id="name" name="country" size="50" value="<?php echo ($guide["country"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>学生证照片</th>
                                <td>
                                    <img src="/weiju2/Public/<?php echo ($guide["schoolpic"]); ?>" width="300px" height="50px"/>
                                    <input type="file" name="schoolpic">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>工作时间</th>
                                <td>
                                    <input class="common-text required" id="name" name="worktime" size="50" value="<?php echo ($guide["worktime"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>工作地点</th>
                                <td>
                                    <input class="common-text required" id="name" name="workplace" size="50" value="<?php echo ($guide["workplace"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>收费/小时</th>
                                <td>
                                    <input class="common-text required" id="name" name="pay" size="50" value="<?php echo ($guide["pay"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>游玩内容</th>
                                <td>
                                    <textarea  name="play"rows="8" cols="60"><?php echo ($guide["play"]); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>是否接机</th>
                                <td>
                                    <input class="common-text required" id="name" name="plane" size="50" value="<?php echo ($guide["plane"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>QQ/WeChat</th>
                                <td>
                                    <input class="common-text required" id="name" name="number" size="50" value="<?php echo ($guide["number"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>精彩瞬间</th>
                                <td>
                                    <img src="/weiju2/Public/<?php echo ($guide["pic"]); ?>" width="300px" height="50px"/>

                                    <input type="file" name="pic">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>自我介绍</th>
                                <td>
                                    <textarea  name="state_introduce"rows="8" cols="60"><?php echo ($guide["introduce"]); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th>上传头像：</th>
                                <td>
                                    <img src="/weiju2/Public/<?php echo ($guide["guide_thumb"]); ?>" width="300px" height="50px"/>
                                    <input type="file" name="guide_thumb"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
